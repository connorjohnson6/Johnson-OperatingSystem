...
//
const APP_NAME: string    = "JohnsonTSOS";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "ThrowMeOutAWindow";   // What did you expect?
...
var _krnKeyboardDisk: TSOS.DeviceDriverDisk  = null;
