        ...
        handleInput() {
            ...
            while (_KernelInputQueue.getSize() > 0) {
                ...
                if (chr === String.fromCharCode(13)) { // the Enter key
                    ...
                    let shellCommands = ['ver', 'help', 'shutdown', 'cls', 'man', 'trace', 'rot13', 'prompt', 'date', 'wherami', 'game', 'status', 'bsod', 'load', 'run', 'clearmem', 'runall', 'ps', 'kill', 'killall', 'quantum', 'format', 'create', 'read', 'write', 'delete', 'copy', 'rename', 'ls'];
